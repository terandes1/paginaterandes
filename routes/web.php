...
//URL PARA ESPAÑOL
Route::get('{lang?}/nuestros-viajes/{search?}', [ 'uses' => 'PublicController@tours' ])->name('paquetesEs');
Route::get('{lang?}/nuestros-viajes/detalle/{slug?}', ['as' => 'tour','uses' => 'PublicController@tour']);
Route::get('{lang?}/categorias/{search?}', [ 'uses' => 'PublicController@tours' ])->name('paquetesCategoriaES');
...
Route::get('{lang?}/nos-voyages/detail/{slug?}', ['as' => 'tour','uses' => 'PublicController@tour']);
Route::get('{lang?}/categories/{search?}', [ 'uses' => 'PublicController@tours' ])->name('paquetesCategoriaFr');
