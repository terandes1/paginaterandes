          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
                 ...
                 <div class="db-2-com db-2-main">
                  	<h4 class="modal-title">ENTREZ VOTRE TEMOIGNAGE</h4>
                </div>
            </div>
                  ...
                  <div class="v2-search-form" style="width: 100%;height: 100%; margin-top: -10px;">
                        <div class="row" style="margin-top: -50px;"></br>
                                <div class="input-field col s6">
                                  <div class="input-field col s12">
                                    ...
                                    <label for="select-city-1" class="">nom complet</label>
                      ...
                      <div class="row">
                                ...
                                <div class="input-field col s6">
                                  <div class="input-field col s12">
                                    ...
                                    <label for="select-city-1" class="">Nationalité</label>
                                ...
                                <div class="input-field col s6">
                                    <div class="input-field col s12">
                                     ...
                                     <label for="select-city-1" class="">Ville</label>
                                    </div>
                                </div>
                      </div>
                      <div class="row">
                                <h5 class="text-center"><strong>IMPRESSION GLOBALE</strong></h5>
                      ...
                      <div class="row" style="margin-left: -61px;margin-top:-32px; ">
                            ...
                            <div class="input-field col s3">
                                    ...
                                    <label for="global3">
                                        <img src="{{ URL::asset('/assets/public/images/encuestas/serious.png') }}" ><strong>INSATISFAIT</strong>
                                    </label>
                            ...
                            <div class="input-field col s3" >
                                    ...
                                    <input type="radio" name="global" id="global4" class="radio input-hidden" value="2">
                                     <label for="global4" >
                                        <img src="{{ URL::asset('/assets/public/images/encuestas/sad.png') }}" ><br><span style="font-size: 9px;"><strong>TRES INSATISFAIT </strong></span> 
                                    </label>
                       ...
                       <div class="row">
                          ...
                          <div class="input-field col s12">
                                <div class="input-field col s12">
                                  <textarea name="testimonial" id="testimonial" class="form-control" rows="4" placeholder="Entrez votre témoignage">{{ old('testimonial') }}</textarea>
                      ...
                      <div class="row">
                            <div class="file-field input-field" style="margin-left: 15px;">
                                <div class="db-up-btn"> <span>Télécharger une image</span>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                                ...
                                <div class="input-field col s4">
                                    ...
                                    <i class="waves-effect waves-light tourz-sear-btn v2-ser-btn waves-input-wrapper" style=""><input type="submit" id="EnviarTestimonio" name="EnviarTestimonio" value="Envoyer maintenant" class="waves-button-input"></i>
                                </div>
                        </div>
