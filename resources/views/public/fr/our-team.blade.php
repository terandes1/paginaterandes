  ...
  <section>
    <div class="rows inner_banner inner_banner_5">
      <div class="container" style="background-color: rgba(22, 23, 19, 0.57)">
	        ...
	        <h2><span style="text-shadow: 2px 2px 4px #000;color: #fff;    font-size: 1.4em; ">Faites connaissance avec la famille des Tierras de los Andes </span></h2>
        <p style="text-shadow: 2px 2px 4px #000;color: #fff;    font-size: 1.4em; text-align: center;">" Chacun des membres de notre équipe unique "</p>
      </div>
    </div>
  </section>
    ...
    <div class="rows inn-page-bg com-colo">
      <div class="container inn-page-con-bg tb-space pad-bot-redu" id="inner-page-title">
        ...
        <div class="spe-title col-md-12">
          <h2 id="titulo">L'ÉQUIPE DES ANDES LAND</h2>
          <div class="title-line">
            <div class="tl-1"></div>
            <div class="tl-2"></div>
            <div class="tl-3"></div>
          </div>
          <p id="subtitulo">Expérience et enthousiasme pour créer et offrir les voyages les plus originaux au Pérou. Nous opérons depuis le cœur des Andes, Cusco, où se trouve notre siège.</p>
        </div>
          ...
          <ul>
            ...
            <li class="col-md-4 col-sm-4 b_packages">
              <div class="tips_travel_2"><img style="width: 80%;" src="{{ asset('assets/public/images/nosotros//trabajadores/1.jpg') }}" alt="" /> 
                ...
                <p id="subtitulo">DIRECTEUR DES VENTES </p>
              </div>
            </li>
            <!--TIPS LIST-->
            <li class="col-md-4 col-sm-4 b_packages">
