      ...
      <div class="col-md-3 tour_r" style="margin-top: -90px;">
        ...
        <div class="tour_right tour_rela tour-ri-com">
          <h3 id="tituloTouLateral">VISITES POPULAIRES</h3>
              ...
              <a style="text-align: center;" href="{{url('fr/nos-voyages/details',['slug' => $item->slug])}}" >
	            ...
	            </p> <a style="text-align: center;" href="{{url('fr/nos-voyages/details',['slug' => $item->slug])}}" class="link-btn" id="tituloTouLateral">Voir plus de détail</a> 
	          </div>
	          @endforeach
        </div>
