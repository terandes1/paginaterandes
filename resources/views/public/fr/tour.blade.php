  ...
  <div class="rows inner_banner inner_banner_4" style="height: 400px;">
    <div class="container">
      ...
      <ul>
        ...
        <li><a href="{{route('paquetesFr','fr')}}" class="bread-acti" id="subtitulo">Tours</a>
        </li>
      </ul>
                ...
                <div class="db-2-com db-2-main" style ="margin-bottom: 40px">
							...
							<ul>
								...
								<li>
									<div class="tr-room-type-list">
										 <a  href="{{url('fr/nos-voyages/detail',['slug' => $item->slug])}}">
                       ...
                       <a  href="{{url('fr/nos-voyages/detail',['slug' => $item->slug])}}">
                          ...
                          {!! $item->name !!}
										...
										<div class="col-md-3 tr-room-type-list-3"> <span class="hot-list-p3-1"> </span> <span class="hot-list-p3-2">$ {{ $item->price}}</span> <a href="{{route('reservation','fr')}}/{{$item->id}}" class="hot-page2-alp-quot-btn spec-btn-text" id="tituloTouRelacionados">RESERVER</a> </div>
									</div>
								</li>
								@endforeach
							</ul>
      ...
      <div class="col-md-3 tour_r" style="margin-top: -90px;">
        ...
        <div class="tour_right tour_offer">
          ...
          <h4>   ${{ $tour->price}}
            ...
            </h4> <a href="{{route('reservation','fr')}}/{{$item->id}}" class="link-btn">RESERVER</a> </div>
        <!--====== TRIP INFORMATION ==========-->
        ...
        <div class="tour_right tour_rela tour-ri-com">
          <h3 id="tituloTouLateral">VISITES POPULAIRES</h3>
              ...
              <a style="text-align: center;" href="{{url('fr/nos-voyages/detail',['slug' => $item->slug])}}" >
	            ...
	            </p> <a style="text-align: center;" href="{{url('fr/nos-voyages/detail',['slug' => $item->slug])}}" class="link-btn" id="tituloTouLateral">Voir plus de détail</a> 
	          </div>
	          @endforeach
        </div>
