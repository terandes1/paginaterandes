...
<section class="tourb2-ab-p-2 com-colo-abou">
  <div class="container">
    ...
    <div class="row tourb2-ab-p1">
      ...
      <div class="col-md-6 col-sm-6">
        <div class="tourb2-ab-p1-right"> <img src="/assets/public/images/iplace-8.jpg" alt="" /> </div>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-md-8 col-sm-6 col-xs-12 testi-2">
        ...
        <div class="arrange">
          <ul>
            <!-- LOCATION MANAGER -->
            <li>
              <a href="#"><img src="/assets/public/images/Location-Manager.png" alt=""> </a>
            </li>
            <!-- PRIVATE GUIDE -->
            <li>
              <a href="#"><img src="/assets/public/images/Private-Guide.png" alt=""> </a>
            </li>
            <!-- ARRANGEMENTS -->
            <li>
              <a href="#"><img src="/assets/public/images/Arrangements.png" alt=""> </a>
            </li>
            <!-- EVENT ACTIVITIES -->
            <li>
              <a href="#"><img src="/assets/public/images/Events-Activities.png" alt=""> </a>
            </li>
          </ul>
        </div>
      </div>
