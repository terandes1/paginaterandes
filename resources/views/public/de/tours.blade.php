                          ...
                          <div class="hot-page2-alp-r-list">
                            ...
                            <div class="col-md-6">
                              <div class="trav-list-bod">
                                <a href="{{url('de/unsere-reises/mehr-sehen',['slug' => $item->slug])}}"><h3  id="tituloTousPrincipal">{{ $item->name }}</h3></a>
                  ...
                  success: function(respuesta) {
                        ...
                        { 
                           htmlTours=htmlTours + "<div class='hot-page2-alp-r-list'>"+ 
                                                     " <div class='col-md-3 hot-page2-alp-r-list-re-sp'>"+ 
                                                         "<a href='../de/unsere-reises/mehr-sehen/"+element.slug+"'>"+
                                                             " <div class='hotel-list-score'>4.5</div>"+
                                                     ...
                                                     "<div class='col-md-6'>"+
                                                    "<div class='trav-list-bod'>"+
                                                   " <a href='../de/unsere-reises/mehr-sehen/"+element.slug+"'><h3>"+element.name+"</h3></a>"+
