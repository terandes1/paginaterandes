		...
		<div class="db"  style="padding: 20px;background: #abb0b4;;">
			...
			<div class="db-l">
				<div class="db-l-1">
					<ul>
						...
						<li><span>25%</span> Rabatt</li>
						<li><span>18</span> Interessiert</li>
					</ul>
				</div>
				<div class="db-l-2">
					<ul>
						<li>
							<a href="{{route('paquetesEs','es')}}" style="font-size: 0.8em;font-family: Lovelo Black;">Kategorie</a>
						</li>
						<li>
							<a href="{{route('paquetesCategoriaDe','de')}}/entdeckung" style="font-size: 0.8em;font-family: Lovelo Black;"><img src="{{URL::asset('assets/public/images/icons/tours/Descubrimiento.png')}}" alt="" /> Entdeckung</a>
						</li>
						<li>
						...
						<li>
							<a href="{{route('paquetesCategoriaDe','de')}}/hoher-berg" style="font-size: 0.8em;font-family: Lovelo Black;"><img src="{{URL::asset('assets/public/images/icons/tours/AltaMontania.png')}}" alt="" /> Hoher Berg</a>
						</li>
						<li>
			...
			<div class="db-2">
				...
				<div class="db-2-com db-2-main">
					<h4 style="font-family: Lovelo Black;">Reservar : {!! $tour->name !!}. <span class="db-pay-amount" style="font-family: Lovelo Black;font-size: 15px;"> <span class="fa fa-clock-o"></span> {{ $dia}} Tage: / {{ $dia-1 }} Nächte </span> </h4>
  					...
  					{!! Form::open(['route' => ['reservations.store'] , 'method' => 'POST']) !!}
                        <div class="form-wrap-two">  
                            <div class="form-group ">
                               	<div class="row">
	                               <div class="col-sm-6">
		                                <h5 id="tituloReserva">Name</h5>
		                                <input type="text" class="form-control"  id="tamanio" name="name" value="{{ old('name') }}" placeholder="Schreibe deinen Namen" value="" required="">
                            ...
                            <div class="form-group">
	                            <div class="row">
	                            	 <div class="col-sm-4">
		                             	 <h5 id="tituloReserva">Telefon</h5>
	                               		 <input type="text" class="form-control" id="tamanio" name="phone" placeholder="Telefonnummer" value="{{ old('phone') }}" required="">
                             ...
                             <div class="form-group">
	                             <div class="row">	
									...
									<div class="col-sm-4">
                                    	<h5 id="tituloReserva">Art der Reise</h5>
	                                ...
	                                <div class="col-sm-4">
                                    	 <h5 id="tituloReserva">Anzahl der Personen</h5>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                    	<h5 id="tituloReserva">Art der Zimmer</h5>
                                    ...
                                    <div class="col-sm-6">
                                    	  <h5 id="tituloReserva">Zusätzliche Reiseleitung</h5>
                                    	  <select  class="select2 form-control" name="guide_service" value="{{ old('guide_service') }}">
												  ...
												  <option value="Otros servicios extra" {{ old('travel_type') == 'Otros servicios extra' ? 'selected' : 'Luxe 4**** +' }}> Andere Extraservices</option>
										</select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                    	<h5 id="tituloReserva">Beschreibe deine Reise</h5>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                	 <div class="col-sm-3">
	                                    ...
	                                    <div class="col-sm-6">
	                                    		 <button class="btn btn-primary btn-block" id="tituloReserva">RESERVIEREN</button> 
	                                    </div>
