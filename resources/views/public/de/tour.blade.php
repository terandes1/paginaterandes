...
<section>
  <div class="rows inner_banner inner_banner_4" style="height: 400px;">
    <div class="container">
      ...
      <ul>
        <li><a href="#inner-page-title" id="subtitulo">Zuhause</a>
        </li>
        <li><i class="fa fa-angle-right" aria-hidden="true"></i> </li>
        <li><a href="{{route('paquetesDe','de')}}" class="bread-acti" id="subtitulo">Touren</a>
        </li>
      </ul>
                ...
                <div class="db-2-com db-2-main">
                    ...
                    <div class="db-2-main-com db-2-main-com-table">
                        <table class="responsive-table">
                            <thead>
                                <tr>
                                    <th><h4 style="font-size: 15px;    font-family: Lovelo Black;">ANKUNFT NACH LIMA</h4></th>
                                    <th><h4 style="font-size: 15px;    font-family: Lovelo Black;">Ausgänge von LIMA </h4></th>
                                    <th><h4 style="font-size: 15px;    font-family: Lovelo Black;">Verfügbarkeit</h4></th>
                                    <th><h4 style="font-size: 15px;    font-family: Lovelo Black;">Staat</h4></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active" style="">
                                        <a href="#letters" data-toggle="tab"><i style="color:black;" class="fa fa-address-card-o"></i>
                                            <span style="font-family: Lovelo Black;">ROUTE</span>
                                        </a>
                                    </li>
                                    <li>
        ...
        <div>
            <div class="dir-rat">
                <div class="dir-rat-inn dir-rat-title">
                  ...
                  <p>Vielen Dank für Ihr Interesse an einer persönlichen Reiseerfahrung mit Tierra de los Andes Peru.</p>
                ...
                <div class="dir-rat-inn">
                 ...
                 <form class ='dir-rat-form'>
                    ...
                    <div class="form-group col-md-6 pad-left-o">
                      <input type="text" class="form-control" id="nameCategoria" name="nameCategoria" placeholder="Gib deinen Namen ein"> 
                      <p class="errorValidacion" id="errorCategoria"></p>
                    </div>
                    <div class="form-group col-md-6 pad-left-o">
                      <input type="number" class="form-control" id="numero"  name="numero" placeholder="Mobil eingeben">
                    ...
                    <div class="form-group col-md-6 pad-left-o">
                      <input type="text" class="form-control" id="ciudad" name="ciudad" placeholder="Gib deine Stadt ein"> 
                      <p class="errorValidacion" id="errorCiudad"></p>
                    </div>
                    <div class="form-group col-md-12 pad-left-o">
                      <textarea placeholder="Schreibe deine Nachricht" id="mensaje" name="mensaje"></textarea>
                    ...
                    <div class="form-group col-md-12 pad-left-o" style="text-align: center;">
                      <input type="submit" value="Senden" id="EnviarReservationTour" name="EnviarReservationTour" class="link-btn"> </div>
                  </form>
                </div>
                ...
                <div class="db-2-com db-2-main" style ="margin-bottom: 40px">
                       ...
                       <a  href="{{url('de/unsere-reises/einzelheiten',['slug' => $item->slug])}}">
                          ...
                          {!! $item->name !!}
										...
										<div class="col-md-3 tr-room-type-list-3"> <span class="hot-list-p3-1"> </span> <span class="hot-list-p3-2">$ {{ $item->price}}</span> <a href="{{route('reservieren','de')}}/{{$item->id}}" class="hot-page2-alp-quot-btn spec-btn-text" id="tituloTouRelacionados">RESERVIEREN</a> </div>
									</div>
								</li>
								@endforeach
							</ul>
      ...
      <div class="col-md-3 tour_r" style="margin-top: -90px;">
        ...
        <div class="tour_right tour_offer">
          ...
          <h4>   ${{ $tour->price}}
            ...
            </h4> <a href="{{route('reservieren','de')}}/{{$item->id}}" class="link-btn">RESERVIEREN</a> </div>
        <!--====== TRIP INFORMATION ==========-->
        
        <!--====== PACKAGE SHARE ==========-->
        <div class="tour_right head_right tour_social tour-ri-com">
          <h3 id="tituloTouLateral">TEILEN SIE DIESES PAKET</h3>
          <ul>
        ...
        <div class="tour_right head_right tour_help tour-ri-com">
          <h3 id="tituloTouLateral">Hilfsdienst</h3>
                 ...
                 $.ajax({
                     ...
                     success: function(data) {
                     		...
                     		var html1="<div class='alert alert-success alert-dismissable'>"+
				                      ...
				                      "<strong>¡ Muchas gracias!</strong>  Ihre Reservierung wurde registriert. In ein paar Minuten werden wir Sie kontaktieren.</div>";
