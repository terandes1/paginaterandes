          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
                 ...
                 <div class="db-2-com db-2-main">
                  	<h4 class="modal-title">GEBEN SIE IHR ZEUGNIS EIN</h4>
                </div>
            </div>
                  ...
                  <div class="v2-search-form" style="width: 100%;height: 100%; margin-top: -10px;">
                        <div class="row" style="margin-top: -50px;"></br>
                                <div class="input-field col s6">
                                  <div class="input-field col s12">
                                    ...
                                    <label for="select-city-1" class="">Name</label>
                      ...
                      <div class="row">
                                ...
                                <div class="input-field col s6">
                                  <div class="input-field col s12">
                                    ...
                                    <label for="select-city-1" class="">Nationalität</label>
                                ...
                                <div class="input-field col s6">
                                    <div class="input-field col s12">
                                     ...
                                     <label for="select-city-1" class="">Stadt</label>
                                    </div>
                                </div>
                      </div>
                      <div class="row">
                                <h5 class="text-center"><strong>GLOBALES DRUCKEN</strong></h5>
                      ...
                      <div class="row" style="margin-left: -61px;margin-top:-32px; ">
                            ...
                            <div class="input-field col s3">
                                    ...
                                    <label for="global3">
                                        <img src="{{ URL::asset('/assets/public/images/encuestas/serious.png') }}" ><strong>UNSATSFIED</strong>
                                    </label>
                            ...
                            <div class="input-field col s3" >
                                    ...
                                    <input type="radio" name="global" id="global4" class="radio input-hidden" value="2">
                                     <label for="global4" >
                                        <img src="{{ URL::asset('/assets/public/images/encuestas/sad.png') }}" ><br><span style="font-size: 9px;"><strong>Sehr unzufrieden </strong></span> 
                                    </label>
                       ...
                       <div class="row">
                          ...
                          <div class="input-field col s12">
                                <div class="input-field col s12">
                                  <textarea name="testimonial" id="testimonial" class="form-control" rows="4" placeholder="Gib dein Zeugnis ein">{{ old('testimonial') }}</textarea>
                      ...
                      <div class="row">
                            <div class="file-field input-field" style="margin-left: 15px;">
                                <div class="db-up-btn"> <span>Bild hochladen</span>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                                ...
                                <div class="input-field col s4">
                                    ...
                                    <i class="waves-effect waves-light tourz-sear-btn v2-ser-btn waves-input-wrapper" style=""><input type="submit" id="EnviarTestimonio" name="EnviarTestimonio" value="Sende jetzt" class="waves-button-input"></i>
                                </div>
                        </div>
