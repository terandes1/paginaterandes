    ...
    <div class="rows inn-page-bg com-colo">
      <div class="container inn-page-con-bg tb-space pad-bot-redu" id="inner-page-title">
        ...
        <div class="spe-title col-md-12">
          <h2>El equipo de Tierras <span>de los Andes</span></h2>
          <div class="title-line">
            <div class="tl-1"></div>
            <div class="tl-2"></div>
            <div class="tl-3"></div>
          </div>
          <p>Experiencia y entusiasmo para crear y ofrecerle los viajes más originales a Perú. Operamos desde el corazón de los Andes, Cusco, donde se encuentra nuestra sede central.</p>
        </div>
        ...
        <div class="tips_travel_1">
          <ul>
            ...
            <li class="col-md-4 col-sm-4 b_packages">
              <div class="tips_travel_2"><img src="{{ asset('assets/public/nosotros/persona.jpg') }}" alt="" /> 
