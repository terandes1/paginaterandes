		...
		<div class="db"  style="padding: 20px;background: #abb0b4;;">
			...
			<div class="db-l">
				...
				<div class="db-l-2">
					<ul>
						<li>
							<a href="{{route('paquetesEs','es')}}" style="font-size: 0.8em;font-family: Lovelo Black;">Categoría</a>
						</li>
						<li>
							<a href="{{route('paquetesCategoriaEn','en')}}/discovery" style="font-size: 0.8em;font-family: Lovelo Black;"><img src="{{URL::asset('assets/public/images/icons/tours/Descubrimiento.png')}}" alt="" /> Discovery</a>
						</li>
						<li>
							<a href="{{route('paquetesCategoriaEn','en')}}/adventure" style="font-size: 0.8em;font-family: Lovelo Black;"><img src="{{URL::asset('assets/public/images/icons/tours/Aventura.png')}}" alt="" /> Adventure</a>
						</li>
						<li>
							<a href="{{route('paquetesCategoriaEn','en')}}/high-mountain" style="font-size: 0.8em;font-family: Lovelo Black;"><img src="{{URL::asset('assets/public/images/icons/tours/AltaMontania.png')}}" alt="" /> High mountain</a>
						</li>
						<li>
							<a href="{{route('paquetesCategoriaEn','en')}}/excursions" style="font-size: 0.8em;font-family: Lovelo Black;"><img src="{{URL::asset('assets/public/images/icons/tours/Excursiones.png')}}" alt="" /> Excursions</a>
						</li>
						<li>
							<a href="{{route('paquetesCategoriaES','fr')}}/viaje-en-grupo" style="font-size: 0.8em;font-family: Lovelo Black;">Viaje en grupo</a>
						</li>
						<li>
							<a href="{{route('paquetesCategoriaES','es')}}/group-travel" style="font-size: 0.8em;font-family: Lovelo Black;"><img src="{{URL::asset('assets/public/images/icons/tours/Aventura.png')}}" alt="" /> Group trave</a>
						</li>
			...
			<div class="db-3" style="border: 1px solid #a2b4c2;">
						...
						<div class="tour_right tour_rela tour-ri-com">
							...
							<a href="/../en/tours/detail/{{ $itemp->slug}}">
