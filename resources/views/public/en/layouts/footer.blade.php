  <style type="text/css" media="screen">
    ...
    <section style="background:#06495c;">
        ...
        <div class="db" style="margin-top: 20px;">
            ...
            <div class="db-3" id="footerContact" style="width: 280px;">
                <h3 style="text-align: center;font-family:  'NewsGoth CN BT';font-size: 1.1em;">CATEGORY</h3>
                <ul>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <a id="textFooter" href="#!"> 
                            ...
                            <h5 id="textFooter" style="color: #a1a2a7;">Address:</h5>
                            Calle Turquezas E-11 Urb. Kennedy A - Cusco
                        </a>
                        <a id="textFooter" href="#!"> 
                            <h5 id="textFooter"  style="font-size: 1.1em; color: #a1a2a7;">Phone: <span style="font-size: 10px;color:#ffffff;" >00 51 84 247277</span></h5>
                    ...
                    <li>
                        ...
                        <a id="textFooter" href="#!"> 
                            <h5 id="textFooter" style="font-size: 1.1em; color: #a1a2a7;">Phone: <span  style="font-size: 10px;color:#ffffff;">00 51 1 2434475</span></h5>
    ...
    <section>
        <div class="rows copy" style="background-color: #161614;">
            <div class="container" >
                <p>Copyrights © 2018 Terandes. All rights reserved</p>
            </div>
        </div>
    </section>
