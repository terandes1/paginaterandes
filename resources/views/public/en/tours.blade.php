  ...
  <div class="rows banner_book" id="inner-page-title">
    <div class="container">
      <div class="banner_book_1">
          ...
          <h3 class="dl4">PERU LUXURY TOURS IN SOUTH AMERICA<span class="tour_star"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-half-o" aria-hidden="true"></i></span>
...
<section class="container">
  ...
  <div class="row">
    <div class="hot-page2-alp-con">
      ...
      <div class="col-md-3 hot-page2-alp-con-left">
        <div class="hot-page2-alp-con-left-1">
            <h3 id="tituloTous">FILTER BY CATEGORY AND PRICE</h3> </div>
        <!--PART 7 : LEFT LISTINGS-->
        
        <!--PART 4 : LEFT LISTINGS-->
        <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
          <h4 id="subtitulo"><i class="fa fa-map-marker" aria-hidden="true"></i>  SELECT CATEGORY</h4>
    ...
    <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
        <h4 id="subtitulo"><i class="fa fa-dollar" aria-hidden="true"></i>PRICE RANGE</h4>
      ...
      <div class="col-md-9 hot-page2-alp-con-right">
        <div class="hot-page2-alp-con-right-1">
          ...
          <h2>We are sorry</h2>
          <h2> We are working to cover your tour packages<h2>
          ...
          <p>
            <a href="/es" type="button" class="btn btn-link">Search again</a>
          </p>
        </div>
            @else
                  @foreach($todoTours as $item)
                          <div class="hot-page2-alp-r-list">
                            ...
                            <div class="col-md-3 hot-page2-alp-r-list-re-sp">
                              <a href="{{url('en/tours/detail',['slug' => $item->slug])}}">
                            ...
                            <div class="col-md-6">
                              <div class="trav-list-bod">
                                <a href="{{url('en/tours/detail',['slug' => $item->slug])}}"><h3  id="tituloTousPrincipal">{{ $item->name }}</h3></a>
                              ...
                              <div class="hot-page2-alp-ri-p3 tour-alp-ri-p3">
                                ...
                                <!-- <span class="hot-list-p3-1" style="text-decoration:line-through;">$ {{(int)$item->price+200}}</span>-->
                                 <span class="hot-list-p3-2">$ {{($item->price)}}</span> <span class="hot-list-p3-4">
                                  <a href="{{route('reserve','en')}}/{{$item->id}}" class="hot-page2-alp-quot-btn" id="tituloTous">RESERVE</a>
                                </span> </div>
                            </div>
                            <div>
                              <div class="trav-ami">
                                <h4 id="tituloTous">Detail and Includes</h4>
                                <ul>
                                  <li><img src="/assets/public/images/icon/a14.png" alt=""> <span>Duration:{{ $item->dias }} Days / {{ (int)$item->dias-1}} Nights</span></li>
                                  <li><img src="/assets/public/images/icon/a15.png" alt=""> <span>hotel</span></li>
                                  <li><img src="/assets/public/images/icon/a16.png" alt=""> <span>To transfer</span></li>
                                  <li><img src="/assets/public/images/icon/a17.png" alt=""> <span>Luggage</span></li>
                                  <li><img src="/assets/public/images/icon/a18.png" alt=""> <span>Tour guide</span></li>
...
<script>
    ...
    function tourOpcionPrecio(precio1,precio2,element)
    {
         ...
         $('#carga').append('<img style="width: 50px;margin-top:100px;" src="{!! URL::asset("assets/public/images/carga/carga.gif") !!}" alt="loading" /><br><h4>Loading...</h4>');
                  ...
                  success: function(respuesta) {
                        ...
                        { 
                           htmlTours=htmlTours + "<div class='hot-page2-alp-r-list'>"+ 
                                                     " <div class='col-md-3 hot-page2-alp-r-list-re-sp'>"+ 
                                                         "<a href='../en/tours/detail/"+element.slug+"'>"+
                                                             " <div class='hotel-list-score'>4.5</div>"+
                                                     ...
                                                     "<div class='col-md-6'>"+
                                                    "<div class='trav-list-bod'>"+
                                                   " <a href='../en/tours/detail/"+element.slug+"'><h3>"+element.name+"</h3></a>"+
                                                    "<p>"+element.description_short.substring(0,150)+"</p>"+
                                                   " </div>"+
                                                  "</div>"+
                                                  "<div class='col-md-3'>"+
                                                   " <div class='hot-page2-alp-ri-p3 tour-alp-ri-p3'>"+
                                                     " <div class='hot-page2-alp-r-hot-page-rat'>25% discount</div> "+
                                                      "<br><span class='hot-list-p3-4'><strong>Since</strong></span> "+
                                                ...
                                                "  </div>"+
                                                 " <div>"+
                                                    ...
                                                    "  <ul>"+
                                                        "<li><img src='/assets/public/images/icon/a14.png' alt=''> <span>"+element.dias+" Days / "+(parseInt(element.dias)-1)+" Nights</span></li>"+
                                                      "  <li><img src='/assets/public/images/icon/a15.png' alt=''> <span>hotel</span></li>"+
                                                       " <li><img src='/assets/public/images/icon/a16.png' alt=''> <span>To transfer</span></li>"+
                                                        "<li><img src='/assets/public/images/icon/a17.png' alt=''> <span>Luggage</span></li>"+
                                                       " <li><img src='/assets/public/images/icon/a18.png' alt=''> <spanTour guide</span></li>"+
                                                       " <li><img src='/assets/public/images/icon/a5.png' alt=''> <span>Menu</span></li>"+
                                                      "</ul>"+
                                                    "</div>"+
                                                 " </div>"+
