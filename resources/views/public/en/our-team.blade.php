    ...
    <div class="rows inn-page-bg com-colo">
      <div class="container inn-page-con-bg tb-space pad-bot-redu" id="inner-page-title">
        ...
        <div class="spe-title col-md-12">
          <h2 id="titulo">The Tierras de los Andes team</h2>
          <div class="title-line">
            <div class="tl-1"></div>
            <div class="tl-2"></div>
            <div class="tl-3"></div>
          </div>
          <p id="subtitulo">Experience and enthusiasm to create and offer the most original trips to Peru. We operate from the heart of the Andes, Cusco, where our headquarters are located.</p>
        </div>
          ...
          <ul>
            ...
            <li class="col-md-4 col-sm-4 b_packages">
              <div class="tips_travel_2"><img style="width: 80%;" src="{{ asset('assets/public/images/nosotros//trabajadores/1.jpg') }}" alt="" /> 
                ...
                <p id="subtitulo">SALES EXECUTIVE </p>
              </div>
            </li>
            <!--TIPS LIST-->
            <li class="col-md-4 col-sm-4 b_packages">
