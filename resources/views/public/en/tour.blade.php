                ...
                <div class="db-2-com db-2-main" style ="margin-bottom: 40px">
							...
							<ul>
								...
								<li>
									<div class="tr-room-type-list">
										 <a  href="{{url('en/tours/detail',['lang' => 'es','slug' => $item->slug])}}">
                       ...
                       <a  href="{{url('en/tours/detail',['slug' => $item->slug])}}">
                          ...
                          {!! $item->name !!}
										...
										<div class="col-md-3 tr-room-type-list-3"> <span class="hot-list-p3-1"> </span> <span class="hot-list-p3-2">$ {{ $item->price}}</span> <a href="{{route('reserve','en')}}/{{$item->id}}" class="hot-page2-alp-quot-btn spec-btn-text" id="tituloTouRelacionados">Reservar ahora</a> </div>
									</div>
								</li>
								@endforeach
							</ul>
      ...
      <div class="col-md-3 tour_r" style="margin-top: -90px;">
        ...
        <div class="tour_right tour_offer">
          ...
          <h4>   ${{ $tour->price}}
            ...
            </h4> <a href="{{route('reserve','en')}}/{{$item->id}}" class="link-btn">RESERVAR AHORA</a> </div>
        <!--====== TRIP INFORMATION ==========-->
        ...
        <div class="tour_right tour_rela tour-ri-com">
          <h3 id="tituloTouLateral">TOURS POPULARES</h3>
              ...
              <a style="text-align: center;" href="{{url('en/tours/detail',['lang' => 'es','slug' => $item->slug])}}" >
	            ...
	            </p> <a style="text-align: center;" href="{{url('en/tour/detail',['slug' => $item->slug])}}" class="link-btn" id="tituloTouLateral">Ver más detalle</a> 
	          </div>
	          @endforeach
        </div>
