...
<section>
  <div class="rows inner_banner inner_banner_4" style="height: 400px;">
    <div class="container">
      ...
      <ul>
        <li><a href="#inner-page-title" id="subtitulo">iniziazione</a>
        </li>
        <li><i class="fa fa-angle-right" aria-hidden="true"></i> </li>
        <li><a href="{{route('paquetesIt','it')}}" class="bread-acti" id="subtitulo">Tours</a>
        </li>
      </ul>
    ...
    <div class="container inn-page-con-bg tb-space">
                ...
                <div class="db-2-com db-2-main">
                    ...
                    <div class="db-2-main-com db-2-main-com-table">
                        <table class="responsive-table">
                            <thead>
                                <tr>
                                    <th><h4 style="font-size: 15px;    font-family: Lovelo Black;">ARRIVI A LIMA</h4></th>
                                    <th><h4 style="font-size: 15px;    font-family: Lovelo Black;">USCITE DI LIMA </h4></th>
                                    <th><h4 style="font-size: 15px;    font-family: Lovelo Black;">DISPONIBILITA '</h4></th>
                                    <th><h4 style="font-size: 15px;    font-family: Lovelo Black;">STATO</h4></th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <div>
            <div class="dir-rat">
                <div class="dir-rat-inn dir-rat-title">
                  ...
                  <p>Grazie per il tuo interesse ad avere un'esperienza di viaggio personalizzata con Tierra de los Andes Peru.</p>
                ...
                <div class="dir-rat-inn">
                 ...
                 <form class ='dir-rat-form'>
                    ...
                    <div class="form-group col-md-6 pad-left-o">
                      <input type="text" class="form-control" id="nameCategoria" name="nameCategoria" placeholder="Inserisci il tuo nome"> 
                      <p class="errorValidacion" id="errorCategoria"></p>
                    </div>
                    <div class="form-group col-md-6 pad-left-o">
                      <input type="number" class="form-control" id="numero"  name="numero" placeholder="Entra nel cellulare">
                    ...
                    <div class="form-group col-md-6 pad-left-o">
                      <input type="text" class="form-control" id="ciudad" name="ciudad" placeholder="Inserisci la tua città"> 
                      <p class="errorValidacion" id="errorCiudad"></p>
                    </div>
                    <div class="form-group col-md-12 pad-left-o">
                      <textarea placeholder="Scrivi il tuo messaggio" id="mensaje" name="mensaje"></textarea>
                    ...
                    <div class="form-group col-md-12 pad-left-o" style="text-align: center;">
                      <input type="submit" value="Inviare" id="EnviarReservationTour" name="EnviarReservationTour" class="link-btn"> </div>
                  </form>
                </div>
                ...
                <div class="db-2-com db-2-main" style ="margin-bottom: 40px">
							...
							<ul>
								...
								<li>
									<div class="tr-room-type-list">
										 <a  href="{{url($abbr.'/il-nostro-viaggio/dettaglio',['lang' => 'es','slug' => $item->slug])}}">
                       ...
                       <a  href="{{url($abbr.'/il-nostro-viaggio/dettaglio',['slug' => $item->slug])}}">
                          ...
                          {!! $item->name !!}
										...
										<div class="col-md-3 tr-room-type-list-3"> <span class="hot-list-p3-1"> </span> <span class="hot-list-p3-2">$ {{ $item->price}}</span> <a href="{{route('prenotazione',$abbr)}}/{{$item->id}}" class="hot-page2-alp-quot-btn spec-btn-text" id="tituloTouRelacionados">Prenota ora</a> </div>
									</div>
								</li>
								@endforeach
							</ul>
      ...
      <div class="col-md-3 tour_r" style="margin-top: -90px;">
        ...
        <div class="tour_right head_right tour_social tour-ri-com">
          <h3 id="tituloTouLateral">SHARE</h3>
          <ul>
        ...
        <div class="tour_right head_right tour_help tour-ri-com">
          <h3 id="tituloTouLateral">SERVIZIO DI ASSISTENZA</h3>
        ...
        <div class="tour_right tour_rela tour-ri-com">
          <h3 id="tituloTouLateral">TOUR POPOLARI</h3>
                 ...
                 $.ajax({
                     ...
                     success: function(data) {
                     		...
                     		var html1="<div class='alert alert-success alert-dismissable'>"+
				                      ...
				                      "<strong>¡ Grazie mille!</strong>  La tua prenotazione è stata registrata. Tra pochi minuti ti contatteremo.</div>";
