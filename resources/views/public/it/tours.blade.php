  ...
  <div class="rows banner_book" id="inner-page-title">
    <div class="container">
      <div class="banner_book_1">
          ...
          <h3 class="dl4">TOUR DI LUSSO PERÙ IN SUD AMERICA <span class="tour_star"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-half-o" aria-hidden="true"></i></span>
...
<section class="container">
  ...
  <div class="row">
    <div class="hot-page2-alp-con">
      ...
      <div class="col-md-3 hot-page2-alp-con-left">
        <div class="hot-page2-alp-con-left-1">
            <h3 id="tituloTous">FILTRA PER CATEGORIA E PREZZO</h3> </div>
        <!--PART 7 : LEFT LISTINGS-->
        
        <!--PART 4 : LEFT LISTINGS-->
        <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
          <h4 id="subtitulo"><i class="fa fa-map-marker" aria-hidden="true"></i>  SELEZIONA CATEGORIA</h4>
    ...
    <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
        <h4 id="subtitulo"><i class="fa fa-dollar" aria-hidden="true"></i>GAMMA PREZZO</h4>
      ...
      <div class="col-md-9 hot-page2-alp-con-right">
        <div class="hot-page2-alp-con-right-1">
          ...
          <h2>Lo sentimos</h2>
          <h2>Stiamo lavorando per coprire i tuoi pacchetti turistici<h2>
          ...
          <p>
            <a href="/it" type="button" class="btn btn-link">Cerca di nuovo</a>
          </p>
        </div>
            @else
                  @foreach($todoTours as $item)
                          <div class="hot-page2-alp-r-list">
                            ...
                            <div class="col-md-3 hot-page2-alp-r-list-re-sp">
                              <a href="{{url($abbr.'/il-nostro-viaggio/dettaglio',['slug' => $item->slug])}}">
                            ...
                            <div class="col-md-6">
                              <div class="trav-list-bod">
                                <a href="{{url($abbr.'/il-nostro-viaggio/dettaglio',['slug' => $item->slug])}}"><h3  id="tituloTousPrincipal">{{ $item->name }}</h3></a>
                            ...
                            <div class="col-md-3">
                              <div class="hot-page2-alp-ri-p3 tour-alp-ri-p3">
                                <div class="hot-page2-alp-r-hot-page-rat">Sconto del 25%</div> <br><span class="hot-list-p3-4"><strong>da</strong></span>
                                <!-- <span class="hot-list-p3-1" style="text-decoration:line-through;">$ {{(int)$item->price+200}}</span>-->
                                 <span class="hot-list-p3-2">$ {{($item->price)}}</span> <span class="hot-list-p3-4">
                                  <a href="{{route('prenotazione',$abbr)}}/{{$item->id}}" class="hot-page2-alp-quot-btn" id="tituloTous">riserva</a>
                                </span> </div>
                            </div>
                            <div>
                              <div class="trav-ami">
                                <h4 id="tituloTous">Dettaglio e Include</h4>
                                <ul>
                                  <li><img src="/assets/public/images/icon/a14.png" alt=""> <span>Durata:{{ $item->dias }} Giorni / {{ (int)$item->dias-1}} Notti</span></li>
                                  <li><img src="/assets/public/images/icon/a15.png" alt=""> <span>Albergo</span></li>
                                  <li><img src="/assets/public/images/icon/a16.png" alt=""> <span>Trasferimento</span></li>
                                  <li><img src="/assets/public/images/icon/a17.png" alt=""> <span>Bagaglio</span></li>
                                  <li><img src="/assets/public/images/icon/a18.png" alt=""> <span>Guida turistica</span></li>
...
<script>
    ...
    function tourOpcionPrecio(precio1,precio2,element)
    {
         ...
         $('#carga').append('<img style="width: 50px;margin-top:100px;" src="{!! URL::asset("assets/public/images/carga/carga.gif") !!}" alt="loading" /><br><h4>caricamento...</h4>');
                  ...
                  success: function(respuesta) {
                        ...
                        { 
                           htmlTours=htmlTours + "<div class='hot-page2-alp-r-list'>"+ 
                                                     " <div class='col-md-3 hot-page2-alp-r-list-re-sp'>"+ 
                                                         "<a href='../it/il-nostro-viaggio/dettaglio/"+element.slug+"'>"+
                                                             " <div class='hotel-list-score'>4.5</div>"+
                                                     ...
                                                     "<div class='col-md-6'>"+
                                                    "<div class='trav-list-bod'>"+
                                                   " <a href='../it/il-nostro-viaggio/dettaglio/"+element.slug+"'><h3>"+element.name+"</h3></a>"+
                                                    "<p>"+element.description_short.substring(0,150)+"</p>"+
                                                   " </div>"+
                                                  "</div>"+
                                                  "<div class='col-md-3'>"+
                                                   " <div class='hot-page2-alp-ri-p3 tour-alp-ri-p3'>"+
                                                     " <div class='hot-page2-alp-r-hot-page-rat'>Sconto del 25%</div> "+
                                                      "<br><span class='hot-list-p3-4'><strong>da</strong></span> "+
                                                       
                                                      "<span class='hot-list-p3-2'>$ "+element.price+" </span><span class='hot-list-p3-4'>"+
                                                       " <a href='{{route('prenotazione',$abbr)}}/"+element.id+"' class='hot-page2-alp-quot-btn'>RISERVA</a>"+
                                                     " </span> </div>"+
                                                "  </div>"+
                                                 " <div>"+
                                                    "<div class='trav-ami'>"+
                                                     " <h4>Dettaglio e Include</h4>"+
                                                    "  <ul>"+
                                                        "<li><img src='/assets/public/images/icon/a14.png' alt=''> <span>"+element.dias+" Giorni / "+(parseInt(element.dias)-1)+" Notti</span></li>"+
                                                      "  <li><img src='/assets/public/images/icon/a15.png' alt=''> <span>Albergo</span></li>"+
                                                       " <li><img src='/assets/public/images/icon/a16.png' alt=''> <span>Trasferimento</span></li>"+
                                                        "<li><img src='/assets/public/images/icon/a17.png' alt=''> <span>Bagaglio</span></li>"+
                                                       " <li><img src='/assets/public/images/icon/a18.png' alt=''> <span>Guida turistica</span></li>"+
                  ...
                  success: function(respuesta) {
                        ...
                        { 
                           htmlTours=htmlTours + "<div class='hot-page2-alp-r-list'>"+ 
                                                     ...
                                                     "<div class='col-md-6'>"+
                                                    "<div class='trav-list-bod'>"+
                                                   " <a href='../il-nostro-viaggio/dettaglio/"+element.slug+"'><h3>"+element.name+"</h3></a>"+
                                                    "<p>"+element.description_short.substring(0,150)+"</p>"+
                                                   " </div>"+
                                                  "</div>"+
                                                  "<div class='col-md-3'>"+
