  <style type="text/css" media="screen">
    ...
    <section style="background:#06495c;">
        ...
        <div class="db" style="margin-top: 20px;">
            <!--LEFT SECTION-->

            <!--RIGHT SECTION-->
            <div class="db-3" id="footerContact" style="width: 280px; ">
                <h3 style="text-align: center;font-family:  'NewsGoth CN BT';font-size: 1.1em;">SOCIAL NETWORKS</h3>
                    ...
                    <ul>
                        ...
                        <ul>
                            <li>
                                 <a>
                                    <i style="padding: 9px;border-radius: 25px; box-shadow: 5px 5px 5px #000; width: 28px; height: 28px; background: rgb(4, 137, 33); color: #FFF;  font-size: 15px; " class="fa fa-phone" aria-hidden="true">
                                     </i>
                                </a> 
                                <a id="textFooter" href="#"><i style="background: #363630;margin: 2px" class="" ></i>Perú: 51 84 247277
                                </a> 
                            </li>

                            <li>
                                <a>
                                    <i style="padding: 7px;border-radius: 25px; box-shadow: 5px 5px 5px #000; width: 28px; height: 28px; background:rgb(4, 137, 33); color: #FFF;  font-size: 15px; " class="fa fa-envelope" aria-hidden="true">
                                     </i>
                                </a> 
                                
                                <a id="textFooter" href="mailto:terandes@terandes.com"> 
                                    <i style="background: #363630;margin: 2px" class="" ></i>terandes@terandes.com
                                </a>
                            </li>
                            <li>
                                <a>
            ...
            <div class="db-3" id="footerContact" style="width: 280px;">
                <h3 style="text-align: center;font-family:  'NewsGoth CN BT';font-size: 1.1em;">CATEGORIA</h3>
                <ul>
                    <li>
                        <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                        <a id="textFooter" href="{{route('paquetesCategoriaIt',$abbr)}}/avventura">
                         Avventura
                    ...
                    <li>
                        <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                        <a href="{{route('paquetesCategoriaIt',$abbr)}}/escursioni" id="textFooter">
                            Escursioni
                        </a>
                    </li>
                    <li>
                        <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                        <a href="{{route('paquetesCategoriaIt',$abbr)}}/alta-montagna" id="textFooter"> 
                            Alta montagna
                        </a>
                    </li>
                    <li>
                        <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                        <a href="{{route('paquetesCategoriaIt',$abbr)}}/scoperta" id="textFooter"> 
                            Scoperta
                        </a>
                    </li>
                    <li>
            ...
            <div class="db-3" id="footerContact" style="width: 280px;">
                <h3 style="text-align: center;font-family:  'NewsGoth CN BT';font-size: 1.1em;">LOCATION</h3>
                ...
                <ul>
                    ...
                    <li>
                        <a id="textFooter" href="#!"> 
                            ...
                            <h5 id="textFooter" style="color: #a1a2a7;">Indirizzo:</h5>
    ...
    <section>
        <div class="rows copy" style="background-color: #161614;">
            <div class="container" >
                <p>Copyrights © 2018 Terandes. Tutti i diritti riservati</p>
            </div>
        </div>
    </section>
