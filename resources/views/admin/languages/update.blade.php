...
<div class="container">
  ...
  {!!Form::model($language, ['url' => ['admin/languages', $language->id],'method'=>'PUT','files'=>true])!!}
  <div class="card">
    <div class="card-body">
          ...
          <div id="kv-avatar-errors-2" class="center-block" style="display:none"></div>
              <div class="kv-avatar">
                  <div class="file-loading">
                      <input id="avatar-1" name="flag" type="file">
                  </div>
              </div>
...
<script type="text/javascript">
  ...
  $(()=>{
    ...
    var arrayJS=<?php echo json_encode($language);?>;

    var imagen='../'+arrayJS.flag;

    if(arrayJS.flag == ''){
      imagen = '<span class="fa fa-flag"></span><h6 class="text-muted">Click to select</h6>';
    }else{
      imagen = '<img src="/'+imagen+'"><h6 class="text-muted">Click to select</h6>';
    }
