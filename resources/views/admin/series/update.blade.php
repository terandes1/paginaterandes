        ...
        <div class="col-sm-3">
            <h5 id="status">Estado</h5>
                ...
                <select  class="form-control"  name="status">
                    <option value="abierto" {{ 'abierto'== $serie->status ? 'selected' : '' }}> abierto </option>
                    <option value="inscrito" {{ 'inscrito'== $serie->status ? 'selected' : '' }}> inscrito </option>
                    <option value="culminado" {{ 'culminado'== $serie->status ? 'selected' : '' }}> culminado </option>
                    <option value="cerrado" {{ 'cerrado'== $serie->status ? 'selected' : '' }}> cerrado </option>
                </select> 
